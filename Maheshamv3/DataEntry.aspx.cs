...
namespace Maheshamv3
{
    public partial class DataEntry : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            string query = $@"SELECT ID,rYear,rMonth,PeriodStart,PeriodEnd,MeterStart,MeterEnd,(MeterEnd - MeterStart) AS Unit,(MeterEnd - MeterStart) * 7 AS Bill,Amount,(Amount + ((MeterEnd - MeterStart) * 7)) AS TotalAmount,PaidAmount,Paidon,Due FROM Rent WHERE Facility = {facilityId} ORDER BY rYear, rMonthNo";
