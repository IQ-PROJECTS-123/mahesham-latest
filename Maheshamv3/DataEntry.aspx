<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DataEntry.aspx.cs" Inherits="Maheshamv3.DataEntry" %>
                            ...
                            <div class="row g-3">
                                ...
                                <asp:GridView ID="gvDataEnrty" class="table table-bordered table-condensed table-responsive table-hover " runat="server" AutoGenerateColumns="false">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PeriodStart" HeaderText="Period Start" DataFormatString="{0:yyyy-MM-dd}" />
                                        <asp:BoundField DataField="PeriodEnd" HeaderText="Period End" DataFormatString="{0:yyyy-MM-dd}" />
                                        <asp:BoundField DataField="Amount" HeaderText="Rent Amount" />
                                        ...
                                        <asp:BoundField DataField="Bill" HeaderText="Electricity Bill" />
                                        <asp:BoundField DataField="TotalAmount" HeaderText="Total Amount" />
                                        <asp:BoundField DataField="PaidAmount" HeaderText="Paid" />
                                        <asp:BoundField DataField="Paidon" HeaderText="Paid On" DataFormatString="{0:yyyy-MM-dd}" />
